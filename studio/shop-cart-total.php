                    ...
                    <div id="resultcont">
                    	<div class="leftcont"> 
                    		<div class="btncart"><a href="#">update shopping bag</a>
                   	 		...
                   	 		<p>*Please note that the exact price of and item is not finalished until you have selected your shipping destination, and will be displayed under *Order Summary* on the Secure Payment Page prior to complete payment.
                    		</p>    
						</div>
                  <div class="rightcont"> 
                    		<div class="subtotal" style="margin:0 0 10px 0;">
                            	<ul>
                            ...
                            <div class="proceed"><a href="#" onclick="event.preventDefault(); $(this).attr('disabled','disabled'); this.innerHTML = 'please wait...'; window.location = 'library/paypal/SetExpressCheckout.php?id=1&name=MYDM.ME Products&price='+removeCommas($('#totalvalue').html())+'&qty=1&tax=0'; " >proceed to purchase</a>
                            </div>
	...
	function writeCart(){
		...
		for (var i = 0; i < cart.length; i++ ) {
			$("#totalcont").append("<table id='totalunit"+i+"' class='totalunit'>"+
									"<tr>"+
									"	<td class='item'><img src='images/shop/thumbs/"+cart[i].image+"'></td>"+
