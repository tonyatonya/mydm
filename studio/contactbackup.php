...
<section id="scontainer">
	<div class ="container clearfix">
		...
		<!-- Form -->	<div id='contact_form_errorloc' class='err'></div>
                        ...
                        <div>
							<label>					
								<textarea placeholder="PROJECT DESCRIPTION" <?php echo htmlentities($user_message) ?> tabindex="1" required></textarea>
							</label>
						</div>
                        <div>
