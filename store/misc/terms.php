...
Please note that these general terms give you specific rights, and you may have other rights, which vary from jurisdiction to jurisdiction.</p>
                            </div>
                        </li>
                        <li>
...
These general terms are not intended to limit the customer’s legal rights nor MYDM’s legal obligations related to product defects in any way including, without limitation, repair or replacement obligations.<br><br>
MYDM does not guarantee the availability of all products in the web shop. MYDM is not liable for any spelling mistakes or incorrect pictures presented in the web shop, nor for incorrect prices or price compensations (such as price changes made by its suppliers or changes in currencies), nor for incorrect information regarding any product’s stock situation. In the event a product ordered by a customer has been given an incorrect price, MYDM shall notify the respective customer of the same prior to an order confirmation and freeze the order until the customer has accepted the new price. All pictures and photos presented in the web shop are only to be referred to as examples and they may not be relied upon in any way, including in relation to the amount, appearance, functionality or origin of the respective product(s). MYDM is not liable for any information provided by third parties for the purposes of the web shop.
...
<h4 style="font-family:'gotham_boldregular'">Exchange</h4>
