...
<div id="cont">
        ...
        products, feel free to contact us:<br>
        E: info@mydm.me</p>
        
        <h3>MYDM STUDIO</h3>
        <p>MYDM studio is our homey place where<br>
        we create all beautiful design.<br><br>
	...
	<div class="style-select">
    	<label for='subject'>select subject require<span class='required'>(required)</span></label>
    	<select name='subject' size="1">
    	  <option>- please select -</option>
          <option>Customer service</option>
          <option>Marketing and PR enquiries</option>
