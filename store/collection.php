    ...
    <article>
        <div class="container clearfix">
            <div class="collcolumn clearfix">
                ...
                <img src="images/collection/hr.svg" style="margin-top:30px; zoom:120%;"><br>
                <img src="images/collection/signature.svg" style="margin-top:10px; zoom:150%;">
            </div>
            <div class="collcolumn2 clearfix">
                <img src="images/collection/head-img-coll1.jpg" alt="collection1" style="margin-top:44px; width:80%;">
    ...
    <article>
        <div class="clearfix">
            <div id="sliderB" class="slider collection-slider">
                <div style="background:url(images/collection/slide1.jpg) no-repeat; background-size:contain; background-position:top center"></div>
    ...
    <article>
        <div class="container clearfix" style="margin-top:80px;">
            <div class="gcoll-left">
                <img src="images/collection/collection01.jpg">
                <img src="images/collection/collection02.jpg">
                <img src="images/collection/collection03.jpg">
            </div>
            <div class="gcoll-right">
                <div class="right1">
                    <img src="images/collection/collection06.jpg">
                    <img src="images/collection/collection07.jpg">
                </div>
                <div class="right2">
                    <img src="images/collection/collection04.jpg">
                    <img src="images/collection/collection05.jpg">
                </div>
            </div>
        </div>
        <div class="container clearfix" style="margin-top:80px; margin-bottom:80px;">
            <img src="images/collection/collection08.jpg" style="width:100%; margin-bottom:4%;">
            <a class="collbtn" href="pdf/MYDM-Catalogue.pdf" target="_blank">DOWNLOAD CATALOGUE</a>
